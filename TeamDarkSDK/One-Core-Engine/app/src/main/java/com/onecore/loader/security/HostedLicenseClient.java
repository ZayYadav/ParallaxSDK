...
/** Fail-closed encrypted client for the pinned TeamDark licensing API. */
@Obfuscate
public final class HostedLicenseClient {
    ...
    private static final String LICENSE_KEY = "TeamDark_LICENSE_KEY";
    private static final String LICENSE_TOKEN = "TeamDark_LICENSE_TOKEN";
    public static final String LICENSE_EXPIRES_AT = "TeamDark_LICENSE_EXPIRES_AT";
    private static final String VERIFIED_SERVER_TIME = "TeamDark_VERIFIED_SERVER_TIME";
    private static final String VERIFIED_ELAPSED_TIME = "TeamDark_VERIFIED_ELAPSED_TIME";
    ...
    public String activate(String activationKey) {
        try {
            ...
            if (!isSupportedActivationKey(normalizedKey)) {
                clearLicense();
                return "Use a key created in TeamDark Control";
            }
    ...
    private static String configuredPublicKey() {
        String value = BuildConfig.TeamDark_API_PUBLIC_KEY_B64;
    ...
    private static String[] configuredPins() {
        String value = BuildConfig.TeamDark_TLS_PINS;
