...
public class ProxyService extends Service {
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".teamdark_core_proxy").setPriority(NotificationCompat.PRIORITY_MAX);
