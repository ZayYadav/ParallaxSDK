...
- Login accepts only `OC-…` activation keys generated by the OneCore Integrity
  dashboard. The in-app key action opens that dashboard, avoiding incompatible
  legacy key formats and response schemas.
