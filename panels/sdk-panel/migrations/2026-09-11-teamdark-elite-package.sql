...
-- Preserve the device binding but move its package identity to the signed successor.
-- The v3 API can then safely rebind the AndroidKeyStore proof key generated by the new app package.
UPDATE devices d
