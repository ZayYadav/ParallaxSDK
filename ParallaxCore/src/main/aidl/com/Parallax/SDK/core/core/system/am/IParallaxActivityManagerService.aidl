// IParallaxActivityManagerService.aidl
...
interface IParallaxActivityManagerService {
    ParallaxAppConfig initProcess(String packageName, String processName, int userId);
    ...
    ParallaxUnbindRecord onServiceUnbind(in Intent proxyIntent, int userId);
    ...
    ParallaxRunningAppProcessInfo getRunningAppProcesses(String callerPackage, int userId);
    ParallaxRunningServiceInfo getRunningServices(String callerPackage, int userId);

    void scheduleBroadcastReceiver(in Intent intent, in ParallaxPendingResultData pendingResultData, int userId);
    void finishBroadcast(in ParallaxPendingResultData data);
    ...
    int checkPermission(String permission, int pid, int uid,String packageName);
}
