// IParallaxPackageManagerService.aidl
...
interface IParallaxPackageManagerService {
    ...
    ParallaxInstallResult installPackageAsUser(String file, in ParallaxInstallOption option, int userId);
    ...
    List<ParallaxInstalledPackage> getInstalledPackagesAsUser(int userId);
