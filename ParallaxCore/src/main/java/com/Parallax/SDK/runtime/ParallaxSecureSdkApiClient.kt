...
/**
 * ParallaxCore activation API v3.
 *
 ...
 */
@Obfuscate
internal class ParallaxSecureSdkApiClient(private val context: Context) {
    ...
    fun activate(userKey: String, packageName: String, appName: String, deviceId: String): JSONObject {
        ...
        val endpointText = ParallaxNative.getSdkPanelEndpoint()
        ...
        return try {
            ...
            connection.setRequestProperty("User-Agent", "ParallaxCore/3.0")
    ...
    private companion object {
        ...
        const val DEVICE_KEY_ALIAS = "parallaxcore_sdk_device_proof_v3"
