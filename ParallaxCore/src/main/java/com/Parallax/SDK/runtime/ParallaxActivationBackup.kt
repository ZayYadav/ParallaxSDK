...
object ParallaxActivationBackup {
    private const val TAG = "ParallaxActivationBackup"
    private const val VERSION = 1
    private const val BACKUP_FILE_NAME = "sdk_activation_backup.json"
    private const val BACKUP_DIR_NAME = ".parallaxcore"
    ...
    private fun backupKey(context: Context): ByteArray {
        val material = listOf(
            "parallaxcore-activation-backup-v1",
            context.packageName,
            androidId(context),
    ...
    private fun backupFiles(context: Context): List<File> {
        ...
        result.add(File(externalRoot, "ParallaxCore/$BACKUP_FILE_NAME"))
