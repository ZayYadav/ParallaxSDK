 ...
 * 此处无Bug
 */
public class ParallaxPackage implements Parcelable {
    ...
    public ParallaxPackageSettings mExtras;
    ...
    public ParallaxPackage(PackageParser.Package aPackage) {
        ...
        // this.mExtras = new ParallaxPackageSettings((PackageSetting) aPackage.mExtras);
    ...
    protected ParallaxPackage(Parcel in) {
        int N = in.readInt();
...
//        this.mExtras = in.readParcelable(ParallaxPackageSettings.class.getClassLoader());
    ...
    public final static class Activity extends Component<ActivityIntentInfo> {
        ...
        public Activity(Parcel parcel) {
            ...
            while (N-- > 0) {
                IntentInfo intentInfo = parcel.readParcelable(ParallaxPackage.class.getClassLoader());
    ...
    public static class IntentInfo implements Parcelable {
        ...
        protected IntentInfo(Parcel in) {
            this.intentFilter = in.readParcelable(ParallaxPackage.class.getClassLoader());
    ...
    public static class Component<II extends ParallaxPackage.IntentInfo> {
        public ParallaxPackage owner;
...
//        dest.writeParcelable(this.mExtras, flags);
    ...
    public static final Parcelable.Creator<ParallaxPackage> CREATOR = new Parcelable.Creator<ParallaxPackage>() {
        @Override
        public ParallaxPackage createFromParcel(Parcel source) {
            return new ParallaxPackage(source);
        }

        @Override
        public ParallaxPackage[] newArray(int size) {
            return new ParallaxPackage[size];
        }
    };
}
