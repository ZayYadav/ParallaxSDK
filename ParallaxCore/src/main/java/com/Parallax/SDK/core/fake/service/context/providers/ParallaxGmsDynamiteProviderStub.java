 ...
 */
public final class ParallaxGmsDynamiteProviderStub extends ParallaxClassInvocationStub implements ParallaxContentProvider {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("query".equals(method.getName())) {
            ...
            if (ParallaxGmsCore.isMeasurementDynamiteUri(uri)) {
    ...
    private static void normalizeRealCaller(Object[] args) {
        ...
        if (attributionClass != null && attributionClass.isInstance(first)) {
            ParallaxContextCompat.fixAttributionSourceState(first, ParallaxCore.getHostUid());
        }
    }
