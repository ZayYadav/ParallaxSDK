 ...
 */
@ParallaxScanClass({IParallaxPackageManagerProxy.class})
public final class IParallaxFacebookWebPackageManagerProxy extends IParallaxPackageManagerProxy {
    ...
    public void injectHook() {
        // Install all original package-manager hooks first. @ParallaxScanClass also scans
    ...
    public static final class ResolveIntentFacebookWebFirst extends ParallaxMethodHook {
        @Override
    ...
    public static final class ResolveServiceFacebookWebFirst extends ParallaxMethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Intent intent = args != null && args.length > 0 && args[0] instanceof Intent
                    ? (Intent) args[0] : null;
     ...
     */
    @ParallaxProxyMethod("queryIntentActivities")
    public static final class QueryFacebookCallbackActivities extends ParallaxMethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Intent intent = args != null && args.length > 0 && args[0] instanceof Intent
                    ? (Intent) args[0] : null;
            ...
            List<ResolveInfo> resolves = ParallaxCore.getBPackageManager()
                    .queryIntentActivities(
                            intent, flags, resolvedType, ParallaxActivityThread.getUserId());
            if (ParallaxParceledListSliceCompat.isReturnParceledListSlice(method)) {
    ...
    private static Object resolveIntentLikeBase(
        ...
        ResolveInfo resolveInfo = ParallaxCore.getBPackageManager().resolveIntent(
                intent, resolvedType, flags, ParallaxActivityThread.getUserId());
        if (resolveInfo != null) {
            return resolveInfo;
        }
        return method.invoke(who, args);
