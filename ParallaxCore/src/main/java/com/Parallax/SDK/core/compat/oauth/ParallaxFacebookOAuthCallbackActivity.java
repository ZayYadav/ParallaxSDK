 ...
 */
@Obfuscate
public final class ParallaxFacebookOAuthCallbackActivity extends Activity {
    ...
    private void handleIntent(Intent intent) {
        ...
        ParallaxFacebookOAuthSessionStore.Claim claim = null;
        boolean delivered = false;
        if (actionOk && schemeOk && hostOk) {
            claim = ParallaxFacebookOAuthSessionStore.claim(callbackUri);
            if (claim != null) {
                delivered = ParallaxVirtualOAuthBridgeActivity.dispatchFacebookCallback(
