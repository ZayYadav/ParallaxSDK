 ...
 */
public class ParallaxReflector {
    public static final String LOG_TAG = "ParallaxReflector";
    ...
    public static ParallaxReflector on(String name) throws Exception {
        return on(name, true, ParallaxReflector.class.getClassLoader());
    }

    public static ParallaxReflector on(String name, boolean initialize) throws Exception {
        return on(name, initialize, ParallaxReflector.class.getClassLoader());
    }

    public static ParallaxReflector on(String name, boolean initialize, ClassLoader loader) throws Exception {
        try {
    ...
    public static ParallaxReflector on(Class<?> type) {
        ParallaxReflector reflector = new ParallaxReflector();
        reflector.mType = type;
        return reflector;
    }

    public static ParallaxReflector with(Object caller) throws Exception {
        return on(caller.getClass()).bind(caller);
    }

    protected ParallaxReflector() {

    }

    public ParallaxReflector constructor(Class<?>... parameterTypes) throws Exception {
        try {
    ...
    public ParallaxReflector bind(Object caller) throws Exception {
        mCaller = checked(caller);
        return this;
    }

    public ParallaxReflector unbind() {
        mCaller = null;
        return this;
    }

    public ParallaxReflector field(String name) throws Exception {
        try {
    ...
    public ParallaxReflector set(Object value) throws Exception {
        return set(mCaller, value);
    }

    public ParallaxReflector set(Object caller, Object value) throws Exception {
        check(caller, mField, "Field");
        try {
    ...
    public ParallaxReflector method(String name, Class<?>... parameterTypes) throws Exception {
        try {
    ...
    public static class QuietReflector extends ParallaxReflector {
