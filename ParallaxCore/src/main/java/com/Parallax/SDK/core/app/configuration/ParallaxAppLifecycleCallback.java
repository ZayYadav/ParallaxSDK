 ...
 * 此处无Bug
 */
public class ParallaxAppLifecycleCallback implements Application.ActivityLifecycleCallbacks {
    public static ParallaxAppLifecycleCallback EMPTY = new ParallaxAppLifecycleCallback() {
