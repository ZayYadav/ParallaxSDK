 ...
 */
@Obfuscate
public final class ParallaxGmsBrokerCompat {
    ...
    private ParallaxGmsBrokerCompat() {
    }
    ...
    public static IBinder wrap(IBinder base) {
        ...
        try {
            IBinder wrapper = (IBinder) Proxy.newProxyInstance(
                    ParallaxGmsBrokerCompat.class.getClassLoader(),
    ...
    private static Object invokeObjectMethod(Object proxy, Method method, Object[] args) {
        switch (method.getName()) {
            ...
            case "toString":
                return "ParallaxGmsBrokerCompat";
            default:
                return null;
        }
    }
    ...
    private static ClassLoader resolveVirtualClassLoader() {
        try {
            if (ParallaxActivityThread.getApplication() != null
                    && ParallaxActivityThread.getApplication().getClassLoader() != null) {
                return ParallaxActivityThread.getApplication().getClassLoader();
            }
        } catch (Throwable ignored) {
        }
        ClassLoader context = Thread.currentThread().getContextClassLoader();
        return context != null ? context : ParallaxGmsBrokerCompat.class.getClassLoader();
    }
    ...
    private static void normalizeServiceRequest(Object request) {
        final String virtualPackage = ParallaxActivityThread.getAppPackageName();
        final String hostPackage = ParallaxCore.getHostPkg();
            ...
            for (Field field : type.getDeclaredFields()) {
                ...
                try {
                    ...
                    if (value instanceof String && virtualPackage.equals(value)) {
                        ...
                        ParallaxContextCompat.fixAttributionSourceState(
                                value, ParallaxCore.getHostUid());
                    }
                } catch (Throwable ignored) {
