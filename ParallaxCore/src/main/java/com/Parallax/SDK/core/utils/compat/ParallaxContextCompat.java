...
import com.Parallax.SDK.mirror.android.app.BRContextImplKitkat;
import com.Parallax.SDK.mirror.android.content.AttributionSourceStateContext;
import com.Parallax.SDK.mirror.android.content.BRAttributionSource;
import com.Parallax.SDK.mirror.android.content.BRAttributionSourceState;
import com.Parallax.SDK.mirror.android.content.BRContentResolver;
 ...
 * 此处无Bug
 */
public class ParallaxContextCompat {
    public static final String TAG = "ParallaxContextCompat";
    ...
    public static void fixAttributionSourceState(Object obj, int uid, int depth) {
        ...
        try {
            if (obj != null && BRAttributionSource.get(obj)._check_mAttributionSourceState() != null) {
                ...
                attributionSourceStateContext._set_packageName(ParallaxCore.getHostPkg());
    ...
    public static void fix(Context context) {
        ...
        final int hostUid = ParallaxCore.getHostUid();
        ...
        try {
            ParallaxVirtualPackageMetadataCompat.install(baseContext);
        } catch (Throwable ignored) {
        }
