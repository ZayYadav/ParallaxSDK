 ...
 * */
public class ParallaxLocation implements Parcelable {
...
//    private float mBearingAccuracyDegrees = 0.0f;
    ...
    public ParallaxLocation() {
    }

    public ParallaxLocation(double latitude, double mLongitude) {
        this.mLatitude = latitude;
        this.mLongitude = mLongitude;
    }

    public ParallaxLocation(Parcel in) {
    ...
    public static final Parcelable.Creator<ParallaxLocation> CREATOR = new Parcelable.Creator<ParallaxLocation>() {
        @Override
        public ParallaxLocation createFromParcel(Parcel source) {
            return new ParallaxLocation(source);
        }

        @Override
        public ParallaxLocation[] newArray(int size) {
            return new ParallaxLocation[size];
        }
    };
