...
import com.Parallax.SDK.core.app.ParallaxRequestPermissionsActivity;
...
public class ParallaxPermissionUtils {
    ...
    public static boolean isCheckPermissionRequired(ApplicationInfo info) {
        if (ParallaxBuildCompat.isM() || ParallaxCore.getContext().getApplicationInfo().targetSdkVersion < Build.VERSION_CODES.M) {
            return false;
        }
    ...
    public static boolean checkPermissions(String[] permissions) {
        ...
        for (String permission : permissions) {
            if (!ParallaxCore.get().checkSelfPermission(permission)) {
                return false;
            }
        }
        return true;
    ...
    public static void startRequestPermissions(Context context, String[] permissions, final CallBack callBack) {
        ParallaxRequestPermissionsActivity.request(context, permissions, new IParallaxRequestPermissionsResult.Stub(){
