 ...
 *
 * ParallaxCore sometimes creates a replacement/shadow Intent below the normal
 ...
 */
public final class ParallaxIntentRedirectCompat {
    ...
    private ParallaxIntentRedirectCompat() {
    }
    ...
    private static Method getCollector() {
        ...
        synchronized (ParallaxIntentRedirectCompat.class) {
            if (sCollectorResolved) {
                return sCollectExtraIntentKeys;
            }
            try {
