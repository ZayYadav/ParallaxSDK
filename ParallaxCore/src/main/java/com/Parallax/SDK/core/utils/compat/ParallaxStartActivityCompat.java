 ...
 * 此处无Bug
 */
public class ParallaxStartActivityCompat {
    ...
    public static void setAppThreadIndex(int appThreadIndex) {
        ParallaxStartActivityCompat.appThreadIndex = appThreadIndex;
    }
    ...
    public static void setCallingPageIndex(int callingPageIndex) {
        ParallaxStartActivityCompat.callingPageIndex = callingPageIndex;
    }
    ...
    public static void setIntentIndex(int intentIndex) {
        ParallaxStartActivityCompat.intentIndex = intentIndex;
    }
    ...
    public static void setResolvedTypeIndex(int resolvedTypeIndex) {
        ParallaxStartActivityCompat.resolvedTypeIndex = resolvedTypeIndex;
    }
    ...
    public static void setResultToIndex(int resultToIndex) {
        ParallaxStartActivityCompat.resultToIndex = resultToIndex;
    }
    ...
    public static void setResultWhoIndex(int resultWhoIndex) {
        ParallaxStartActivityCompat.resultWhoIndex = resultWhoIndex;
    }
    ...
    public static void setRequestCodeIndex(int requestCodeIndex) {
        ParallaxStartActivityCompat.requestCodeIndex = requestCodeIndex;
    }
    ...
    public static void setFlagsIndex(int flagsIndex) {
        ParallaxStartActivityCompat.flagsIndex = flagsIndex;
    }
    ...
    public static void setProfilerInfoIndex(int profilerInfoIndex) {
        ParallaxStartActivityCompat.profilerInfoIndex = profilerInfoIndex;
    }
    ...
    public static void setOptionsIndex(int optionsIndex) {
        ParallaxStartActivityCompat.optionsIndex = optionsIndex;
    }
}
