 ...
 */
public class ParallaxTokenCache {
    public int userId;
    ...
    public ParallaxTokenCache(int userId,Account account,
                      String callerPkg,
                      String tokenType,
                      String token,
                      long expiryMillis) {
    ...
    public ParallaxTokenCache(int userId, Account account, String authTokenType, String packageName) {
        this.userId = userId;
        this.account = account;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ParallaxTokenCache)) return false;
        ParallaxTokenCache that = (ParallaxTokenCache) o;
