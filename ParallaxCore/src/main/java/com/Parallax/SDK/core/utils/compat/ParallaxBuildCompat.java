...
public class ParallaxBuildCompat {
    ...
    public static boolean isEMUI() {
        ...
        String property = ParallaxSystemPropertiesCompat.get("ro.build.version.emui");
        return property != null && property.contains("EmotionUI");
    }

    public static boolean isMIUI() {
        return ParallaxSystemPropertiesCompat.getInt("ro.miui.ui.version.code", 0) > 0;
    }
    ...
    public static boolean isColorOS() {
        return ParallaxSystemPropertiesCompat.isExist("ro.build.version.opporom")
                || ParallaxSystemPropertiesCompat.isExist("ro.rom.different.version");
    }

    public static boolean is360UI() {
        String property = ParallaxSystemPropertiesCompat.get("ro.build.uiversion");
    ...
    public static boolean isVivo() {
        return ParallaxSystemPropertiesCompat.isExist("ro.vivo.os.build.display.id");
    }
