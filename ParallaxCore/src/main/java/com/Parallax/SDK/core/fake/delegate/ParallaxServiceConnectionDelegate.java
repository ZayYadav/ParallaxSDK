...
public class ParallaxServiceConnectionDelegate extends IServiceConnection.Stub {
    private static final Map<IBinder, ParallaxServiceConnectionDelegate> sServiceConnectDelegate = new HashMap<>();
    private final IServiceConnection mConn;
    private final ComponentName mComponentName;

    private ParallaxServiceConnectionDelegate(IServiceConnection mConn, ComponentName targetComponent) {
        this.mConn = mConn;
        this.mComponentName = targetComponent;
    }

    public static ParallaxServiceConnectionDelegate getDelegate(IBinder iBinder) {
    ...
    public static IServiceConnection createProxy(IServiceConnection base, Intent intent) {
        ...
        ParallaxServiceConnectionDelegate delegate = sServiceConnectDelegate.get(iBinder);
        if (delegate == null) {
            try {
            ...
            delegate = new ParallaxServiceConnectionDelegate(base, intent.getComponent());
