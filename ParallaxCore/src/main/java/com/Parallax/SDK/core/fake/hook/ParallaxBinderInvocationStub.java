 ...
 * 此处无Bug
 */
public abstract class ParallaxBinderInvocationStub extends ParallaxClassInvocationStub implements IBinder {
    private IBinder mBaseBinder;

    public ParallaxBinderInvocationStub(IBinder baseBinder) {
