 ...
 */
@Obfuscate
public final class ParallaxVirtualOAuthRouter {
    public static final String EXTRA_AUTH_URL =
            "com.Parallax.SDK.core.oauth.AUTH_URL";
    public static final String EXTRA_REDIRECT_URI =
            "com.Parallax.SDK.core.oauth.REDIRECT_URI";
    public static final String EXTRA_VIRTUAL_PACKAGE =
            "com.Parallax.SDK.core.oauth.VIRTUAL_PACKAGE";
    public static final String EXTRA_USER_ID =
            "com.Parallax.SDK.core.oauth.USER_ID";
    public static final String EXTRA_AUTH_PROVIDER =
            "com.Parallax.SDK.core.oauth.AUTH_PROVIDER";
    ...
    private ParallaxVirtualOAuthRouter() {
    }
    ...
    public static Intent createBridgeIntent(Intent source, int userId, String virtualPackage) {
        ...
        String authProvider = ParallaxAuthTabCompat.findProvider(
                ParallaxCore.getContext(), authUri);
    ...
    private static Uri bestDeclaredTwitterRedirect(String virtualPackage, int userId) {
        try {
            List<Uri> candidates = ParallaxDeclaredOAuthCallbackResolver.findCandidates(
