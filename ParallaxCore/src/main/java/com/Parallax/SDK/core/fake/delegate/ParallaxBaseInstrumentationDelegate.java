...
public class ParallaxBaseInstrumentationDelegate extends Instrumentation {
    ...
    private static ParallaxReflector invokeExecStartActivity(Object obj, Class<?>... args) throws NoSuchMethodException {
        Class<?> cls = obj.getClass();
        while (cls != null) {
            try {
                return ParallaxReflector.on(obj.getClass()).method("execStartActivity", args);
            } catch (Exception e) {
