...
public class ParallaxComponentUtils {
    ...
    public static boolean isSelf(Intent intent) {
        ...
        if (component == null || ParallaxActivityThread.getAppPackageName() == null) return false;
        return component.getPackageName().equals(ParallaxActivityThread.getAppPackageName());
    }
