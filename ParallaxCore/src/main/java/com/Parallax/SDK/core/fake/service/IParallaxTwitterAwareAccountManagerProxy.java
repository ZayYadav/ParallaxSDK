 ...
 */
@Obfuscate
@ParallaxScanClass(IParallaxAccountManagerProxy.class)
public final class IParallaxTwitterAwareAccountManagerProxy extends IParallaxAccountManagerProxy {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("getAuthenticatorTypes".equals(name)) {
            ...
            try {
                ...
                ParallaxSlog.d(TAG, "real authenticator lookup unavailable: " + e.getClass().getSimpleName());
        ...
        if (shouldUseRealTwitterAuthenticator(name, args)) {
            try {
                ...
                ParallaxSlog.d(TAG, "native Twitter account call failed for " + name
    ...
    private Object invokeSystem(Method method, Object[] originalArgs, boolean replaceUserId)
        ...
        if (hostArgs != null) {
            ...
            ParallaxMethodParameterUtils.replaceAllAppPkg(hostArgs);
            sanitizeOptionBundles(hostArgs);
            if (replaceUserId) {
                ParallaxMethodParameterUtils.replaceLastUserId(hostArgs);
            }
        }
    ...
    private static void sanitizeOptionBundles(Object[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            copy.putString("androidPackageName", ParallaxCore.getHostPkg());
            args[i] = copy;
        }
    }
