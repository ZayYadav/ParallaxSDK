...
import com.Parallax.SDK.mirror.android.content.BRBroadcastReceiverPendingResult;
import com.Parallax.SDK.mirror.android.content.BRBroadcastReceiverPendingResultM;
import com.Parallax.SDK.mirror.android.content.BroadcastReceiverPendingResultContext;
import com.Parallax.SDK.mirror.android.content.BroadcastReceiverPendingResultMContext;
import com.Parallax.SDK.core.utils.compat.ParallaxBuildCompat;

/**
 * Created by BlackBox on 2022/2/28.
 */
public class ParallaxPendingResultData implements Parcelable {
    ...
    public ParallaxPendingResultData(BroadcastReceiver.PendingResult pendingResult) {
    ...
    protected ParallaxPendingResultData(Parcel in) {
    ...
    public static final Parcelable.Creator<ParallaxPendingResultData> CREATOR = new Parcelable.Creator<ParallaxPendingResultData>() {
        @Override
        public ParallaxPendingResultData createFromParcel(Parcel source) {
            return new ParallaxPendingResultData(source);
        }

        @Override
        public ParallaxPendingResultData[] newArray(int size) {
            return new ParallaxPendingResultData[size];
        }
    };
    

    public String toString() {
        return "ParallaxPendingResultData{mType=" + this.mType + ", mOrderedHint=" + this.mOrderedHint + ", mInitialStickyHint=" + this.mInitialStickyHint + ", mToken=" + this.mToken + ", mSendingUser=" + this.mSendingUser + ", mFlags=" + this.mFlags + ", mResultCode=" + this.mResultCode + ", mResultData='" + this.mResultData + '\'' + ", mResultExtras=" + this.mResultExtras + ", mAbortBroadcast=" + this.mAbortBroadcast + ", mFinished=" + this.mFinished + '}';
    }
}
