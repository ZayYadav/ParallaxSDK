...
# --- Source Files ---
ParallaxCore_CORE_SRC := $(wildcard $(LOCAL_PATH)/*.cpp)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/Hook/*.cpp)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/IO/*.cpp)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/JniHook/*.cpp)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/SandHook/*.cpp)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/KittyMemory/*.cpp)   # <-- ADDED

LOCAL_C_INCLUDES += $(LOCAL_PATH)/Riyaz

# C Files (xdl - SandHook/xdl)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/SandHook/xdl/*.c)
# C Files (libzip - SandHook/libzip)
ParallaxCore_CORE_SRC += $(wildcard $(LOCAL_PATH)/SandHook/libzip/*.c)

LOCAL_SRC_FILES := $(ParallaxCore_CORE_SRC:$(LOCAL_PATH)/%=%)
