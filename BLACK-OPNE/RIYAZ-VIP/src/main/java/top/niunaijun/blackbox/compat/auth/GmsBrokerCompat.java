 ...
 *
 * Virtual applications execute under the Loader UID. Android 16 / modern Play
 * services validates the package carried by GetServiceRequest against the real
 * Binder caller UID. Before a request crosses into the real GMS process, normalize
 * only caller-identity fields to the Loader host package/UID.
 *
 * OAuth client IDs, accounts, tokens, signatures, scopes and provider responses
 * are intentionally left untouched. Provider-side authorization stays in force.
 */
        ...
        while (type != null && type != Object.class) {
            for (Field field : type.getDeclaredFields()) {
                ...
                try {
                    ...
                    // Play services internals vary by version. Normalize only fields
