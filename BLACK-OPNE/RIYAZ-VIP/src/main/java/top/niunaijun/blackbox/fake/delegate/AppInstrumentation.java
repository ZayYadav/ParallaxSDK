...
import top.niunaijun.blackbox.compat.firebase.FirebaseCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    private static final String RIFLE_APP_CLASS =
    ...
    public void fixRifleHook() {
        ...
        if (RIFLE_APP_CLASS.equals(mInstrumentation.getClass().getName())) {
            AppInstrumentation appInstrumentation =
                    (AppInstrumentation) BRActivityLifeCycleHelper$ApplicationInstrumentation
                            .get(mInstrumentation).mBase();
    ...
    private void fixSharedLibraryLoaders(ClassLoader cl) {
        try {
            Object classLoaders = BRBaseDexClassLoader
                    .get(ContextCompat.class.getClassLoader()).sharedLibraryLoaders();
    ...
    public void callApplicationOnCreate(Application app) {
        ...
        // FirebaseInitProvider normally creates the default FirebaseApp before
        // Application.onCreate. If provider installation was missed by the virtual
        // ActivityThread, recover using only the guest application's own bundled
        // Firebase resources/metadata before its first Activity starts.
        FirebaseCompat.ensureDefaultApp(app);
    }
