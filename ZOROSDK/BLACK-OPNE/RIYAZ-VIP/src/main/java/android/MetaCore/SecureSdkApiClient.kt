...
internal class SecureSdkApiClient(private val context: Context) {
    ...
    private fun getOrCreateDeviceKey(): java.security.KeyPair {
        ...
        val activeAlias = when {
            ...
            store.containsAlias(LEGACY_DEVICE_KEY_ALIAS) -> LEGACY_DEVICE_KEY_ALIAS
            else -> {
    ...
    private companion object {
        ...
        const val DEVICE_KEY_ALIAS = "zorosdk_sdk_device_proof_v3"
        const val LEGACY_DEVICE_KEY_ALIAS = "keshavxowner_sdk_device_proof_v3"
