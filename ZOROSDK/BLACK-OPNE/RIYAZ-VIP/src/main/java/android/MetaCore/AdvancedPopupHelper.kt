...
<main class="card">
  <header class="top">
<div><div class="eyebrow">ZOROSDK / ONECORE</div><div class="brand">Runtime access</div></div>
  </header>
  <section class="hero">
    <div class="lock">
  ...
  <div class="notice">
    ...
    <span>ZOROSDK Core supports API 24-36. Contact your authorized provider to renew access.</span>
  </div>
  <div class="actions">
